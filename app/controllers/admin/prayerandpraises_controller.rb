...
class Admin::PrayerandpraisesController < Admin::MasterController
  def index 
...
=begin
  ...
  #
  #   admin:
  #     Prayerandpraise: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Prayerandpraise: create, read, update, custom_action_for_an_item
  #
