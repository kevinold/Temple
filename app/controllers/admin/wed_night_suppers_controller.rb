...
class Admin::WedNightSuppersController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     WedNightSupper: create, read, update, destroy, custom_action
  #
  #   editor:
  #     WedNightSupper: create, read, update, custom_action_for_an_item
  #
