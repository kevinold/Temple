...
SimpleNavigation::Configuration.run do |navigation|  
  ...
  navigation.items do |primary|
    ...
    #primary.item :home, 'Home', home_path, {:id => nil, :class => nil}
    primary.item :home, 'Home', home_path
    primary.item :sermons, 'Sermons', sermons_path
    primary.item :calendar, 'Calendar', calendar_path
    primary.item :prayer, 'Prayer', prayer_path
    ...
    primary.item :announcements, 'Announcements', announcements_path
